...
def lookup(name: str) -> str:
    ...
    agent = initialize_agent(tools= tools_for_agent, llm=llm, agent=AgentType.ZERO_SHOT_REACT_DESCRIPTION, verbose=True) #Agent-Types
    prompt_templet = PromptTemplate(template=template, input_variables=['name_of_person'])
